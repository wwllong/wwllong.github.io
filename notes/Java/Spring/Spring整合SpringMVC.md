...
<beans xmlns="http://www.springframework.org/schema/beans" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <context:component-scan base-package="com.wenwl.my.shop" use-default-filters="false">
...
* `mvc:resources`：静态资源映射，主要用于配置静态资源文件存放路径，如：JS、CSS、Image 等。'**'是全路径通配符，‘*’是当前路径通配符。
