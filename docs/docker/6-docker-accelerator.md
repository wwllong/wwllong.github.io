...
- [阿里云加速器](https://cr.console.aliyun.com/cn-shenzhen/instances/mirrors)
...
注意，一定要保证该文件符合 json 规范，否则 Docker 将不能启动。Docker客户端版本大于 1.10.0 
...
在列表中填写加速器地址 `https://registry.docker-cn.com`。修改完成之后，点击 `Apply & Restart` 按钮，Docker 就会重启并应用配置的镜像地址了。
